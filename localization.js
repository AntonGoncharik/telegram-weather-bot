...
const strings = new LocalizedStrings({
    ...
    ru: {
        ...
        tempMorn: 'Темп. утром',
        tempDay: 'Темп. днем',
        tempEve: 'Темп. вечером',
        tempNight: 'Темп. ночью',
        tempFeelsLikeMorn: 'Как ощущ. утром',
        tempFeelsLikeDay: 'Как ощущ. днем',
        tempFeelsLikeEve: 'Как ощущ. вечером',
        tempFeelsLikeNight: 'Как ощущ. ночью',
