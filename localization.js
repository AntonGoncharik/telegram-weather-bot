...
const strings = new LocalizedStrings({
    en: {
        ...
        tempMorn: 'Temperature morn.',
        tempDay: 'Temperature day',
        tempEve: 'Temperature eve.',
        tempNight: 'Temperature night.',
        tempFeelsLikeMorn: 'Feels like morn.',
        tempFeelsLikeDay: 'Feels like day',
        tempFeelsLikeEve: 'Feels like eve.',
        tempFeelsLikeNight: 'Feels like night',
    ...
    ru: {
        ...
        tempMorn: 'Температура утром',
        tempDay: 'Температура днем',
        tempEve: 'Температура вечером',
        tempNight: 'Температура ночью',
        tempFeelsLikeMorn: 'Как ощущается утром',
        tempFeelsLikeDay: 'Как ощущается днем',
        tempFeelsLikeEve: 'Как ощущается вечером',
        tempFeelsLikeNight: 'Как ощущается ночью',
